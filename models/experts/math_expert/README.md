...
# Load model
checkpoint = torch.load("models/experts/math_expert/model.pt")
...
```bash
python scripts/train_expert.py --expert-id math_expert --data path/to/data.jsonl
```
